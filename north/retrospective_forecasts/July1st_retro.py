...
df_dt.to_csv('./July1st_detrended_forecasts_'+str(fmin)+'-'+str(fmax)+'.csv')
df_rt.to_csv('./July1st_forecasts_with_trend_'+str(fmin)+'-'+str(fmax)+'.csv')
